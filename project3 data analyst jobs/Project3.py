...
df = pd.read_csv("D:\DataAnalyst.csv")
...
#df['Job_Title']=df['Job_Title'].str.replace(" ", "_").str.lower()
# print(df['Job_Title'].unique())

# df['Job_Title']= df['Job_Title'].str.contains('Junior Data Analyst').replace('','Junior Data Analyst', regex=True)
...
plt.xticks(rotation=90)
plt.xlabel('Average Salary (Thousands Dollars)')
plt.ylabel('Sector')
